...
namespace OpenTwitchPlays
{
    ...
    public partial class MainWindow : Form
    {
        ...
        enum ControlStates { Keyboard, Joypad };
        ...
        private void useJoypadButton_Click(object sender, EventArgs e)
        {
            if (menuUseJoypad.Checked)
            {
                menuUseJoypad.Checked = false;
                
            }
            else
            {
                menuUseJoypad.Checked = true;
